...
urlpatterns = [
    ...
    path("index.html", login_required(views.index),
         name="index"),
    ...
    path("invoices/<int:pk>/pdf/", views.invoice_pdf,
         name="invoice-pdf"),
    path("invoices/<int:pk>/settle/", views.settle_invoice,
         name="invoice-settle"),
    path("invoices/<int:pk>/unsettle/", views.unsettle_invoice,
         name="invoice-unsettle"),
